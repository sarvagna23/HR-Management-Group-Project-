...
public class CheckDB extends JFrame {
	 ...
	 */
	public CheckDB() {
		setIconImage(Toolkit.getDefaultToolkit().getImage("D:\\Project\\icon.jpeg"));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
	                ...
	                JOptionPane.showMessageDialog(null, "Database is all set..", "Sucess", JOptionPane.INFORMATION_MESSAGE);
	                dispose();
	            } catch (Exception a) {
	            	JOptionPane.showMessageDialog(null, "Incorrect Username/Password", "Failed", JOptionPane.ERROR_MESSAGE);
	            	user = null;
	            	password = null;
	            }
			}
		...
		txtrHiiThereMy.setText(" Server(localhost)\r\n Username (Postgresql)\r\n Password (Postgresql)\r\n\r\n Refer guide to setup\r\n sample database");
